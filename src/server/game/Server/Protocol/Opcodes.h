...
enum OpcodeServer : uint16
{
    ...
    SMSG_AVAILABLE_HOTFIXES                           = 0x1EBA,
    ...
    SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT        = 0x169F,
    ...
    SMSG_QUERY_CREATURE_RESPONSE                      = 0x048B,
