...
struct ItemSparseEntry
{
    ...
    uint32 InventoryType;
    int32 AllowableClass;
    Trinity::RaceMask<int32> AllowableRace;
    uint32 ItemLevel;
    ...
    std::array<int32, MAX_ITEM_PROTO_STATS> ItemStatType;
    std::array<int32, MAX_ITEM_PROTO_STATS> ItemStatValue;
    std::array<int32, MAX_ITEM_PROTO_STATS> ItemScalingValue;
    std::array<float, MAX_ITEM_PROTO_STATS> ItemSocketCostRate;
    uint32 ScalingStatDistributionID;
    uint32 DamageType;
    uint32 Delay;
    float RangedModRange;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellID;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellTrigger;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellCharges;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellCooldown;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellCategory;
    std::array<int32, MAX_ITEM_PROTO_SPELLS> SpellCategoryCooldown;
    uint32 Bonding;
    LocalizedString* Display;
    ...
    std::array<uint32, MAX_ITEM_PROTO_SOCKETS> Color;
    std::array<uint32, MAX_ITEM_PROTO_SOCKETS> Content;
    int32 SocketBonus;
    ...
    static const uint32 ContentTuningID = 0;

    // Shaohao: MOP doesn't have ContentTuningID
    static const uint32 PlayerLevelToItemLevelCurveID = 0;

    // Shaohao: MOP doesn't have ArtifactID
    static const uint8 ArtifactID = 0;

    // Shaohao: MOP doesn't have ExpansionID
    static const uint8 ExpansionID = 0;

    // Shaohao: MOP doesn't have FactionRelated
    static const uint32 FactionRelated = 0;
