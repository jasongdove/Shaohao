...
//
//DB2StorageBase::DB2StorageBase(char const* fileName, char const* format)
//    : _tableHash(0), _layoutHash(0), _fileName(fileName), _fieldCount(0), _format(format), _dataTable(nullptr), _dataTableEx(),
